    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <section className="max-w-7xl mx-auto px-6 py-24 text-center ">
          ...
          {/* Main heading */}
          <h1 className="text-5xl font-extrabold text-gray-900 leading-tight">One Platform for {" "}
            <span className="text-blue-600">Campus Placements</span>
          </h1>
          ...
          <div className="mt-10 flex justify-center gap-4">
            ...
            <Link
              to="#features"
              className="px-6 py-3 rounded-md border-gray-300 text-gray-700 bg-gray-200 hover:bg-gray-300 transition"
            >
              Learn More
            </Link>
          </div>
        ...
        {/* ============ FEATURES SECTION ============== */}
        <section
          id="features" className="bg-white py-20"
        >
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              {/* =========== FEATURE CARD 1 ========== */}
              <div className="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-md transition hover:scale-105 border">
                {/* Icon circle */}
              ...
              {/* =========== FEATURE CARD 2 ========== */}
              <div className="bg-gray-50 p-8 border rounded-xl shadow-sm hover:shadow-md hover:scale-105 transition">
              ...
              {/* =========== FEATURE CARD 3 ========== */}
              <div className="bg-gray-50 p-8 border rounded-xl shadow-sm hover:shadow-md transition hover:scale-105">
